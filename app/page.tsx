          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card className="bg-white/10 backdrop-blur-md border-white/20">
              <CardContent className="pt-6">
                ...
                <p className="text-gray-300 mb-4">
                  " &quot;Archon has completely transformed how I manage my
                  daily tasks and long-term goals. The AI insights are
                  incredibly helpful!&quot;"
                </p>
            ...
            <Card className="bg-white/10 backdrop-blur-md border-white/20">
              <CardContent className="pt-6">
                ...
                <p className="text-gray-300 mb-4">
                  " &quot;The customizable dashboard is perfect for my workflow.
                  I can see everything I need at a glance and stay focused on
                  what matters.&quot;"
                </p>
                <div className="flex items-center">
            ...
            <Card className="bg-white/10 backdrop-blur-md border-white/20">
              <CardContent className="pt-6">
                ...
                <p className="text-gray-300 mb-4">
                  " &quot;I love the journaling feature. It helps me reflect on
                  my progress and stay motivated. The analytics show how much
                  I&apos;ve grown!&quot;"
                </p>
                <div className="flex items-center">
